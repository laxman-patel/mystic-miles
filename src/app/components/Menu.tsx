...
<div className="bg-white transition-all z-50 justify-around flex flex-col py-24 items-center fixed left-0 h-screen w-full lg:w-1/3">
  ...
  <div onClick={() => setIsOpen(false)} className=" lg:fixed right-0 h-full w-2/3 bg-black/20 z-50 backdrop-blur-md">
  </div>
</>
  );
}
