  ...
  return (
    <div id="catalog" className="flex px-7 mt-12 lg:px-14 lg:py-10 flex-col justify-between items-center w-full lg:h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-24 pt-16 place-items-center" >
         ...
         <div className="flex flex-col items-center max-h-64 lg:max-h-96 lg:h-96 justify-around max-w-80  lg:max-w-96  border border-white hover:scale-105 hover:border-gold transition-all bg-white/5 px-5 py-10">
            <Image src={item[2]} className="max-h-36 lg:max-h-96 grayscale" width={1000} height={1000} alt="" />
