...
export default function LoadMore({dataRes}) {
    ...
    return <>
       ...
       {dataRes.map((item, _idx) => 
         <div className="flex flex-col items-center max-h-64 lg:max-h-96 lg:h-96 justify-around max-w-96  border border-white hover:scale-105 hover:border-gold transition-all bg-white/5 px-5 py-10">
