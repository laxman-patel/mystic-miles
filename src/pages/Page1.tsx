...
export default function Page1() {
  return (
<div id="hero" className="flex  px-7  lg:px-14 lg:py-10 flex-col justify-between items-center w-full h-full lg:h-screen">
    <div className="flex flex-col relative items-center justify-center my-80 lg:my-28">
